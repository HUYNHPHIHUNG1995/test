...
<form action="{{route('postEditUser',$userById->id)}}" method="post" class="box">
    @csrf
                            ...
                            <div class="col-lg-6">
                                <div class="form-row">
                                    ...
                                    <input 
                                        type="text"
                                        name="email"
                                        value="{{ old('email', ($userById->email) ?? '' ) }}"
                                        class="form-control"
                                        placeholder=""
                                        autocomplete="off"
                                    >
                            ...
                            <div class="col-lg-6">
                                <div class="form-row">
                                    ...
                                    <select name="user_catalogue_id" class="form-control setupSelect2">
                                        ...
                                        <option {{ 
                                            $key == old('user_catalogue_id', (isset($userById->user_catalogue_id)) ? $userById->user_catalogue_id : '') ? 'selected' : '' 
                            ...
                            <div class="col-lg-6">
                                <div class="form-row">
                                    ...
                                    <input 
                                        type="date"
                                        name="birthday"
                                        value="{{ old('birthday', (isset($userById->birthday)) ? date('Y-m-d', strtotime($userById->birthday)) : '') }}"
                                        class="form-control"
                                        placeholder=""
                                        autocomplete="off"
                                    >
                            ...
                            <div class="col-lg-12">
                                <div class="form-row">
                                    ...
                                    <input 
                                        type="text"
                                        name="image"
                                        value="{{ old('image', ($userById->image) ?? '') }}"
                            ...
                            <div class="col-lg-6">
                                <div class="form-row">
                                    ...
                                    <input 
                                        type="text"
                                        name="address"
                                        value="{{ old('addresss', ($userById->address) ?? '') }}"
                                        class="form-control"
                                        placeholder=""
                                        autocomplete="off"
                                    >
                            ...
                            <div class="col-lg-6">
                                <div class="form-row">
                                    ...
                                    <input 
                                        type="text"
                                        name="phone"
                                        value="{{ old('phone', ($userById->phone) ?? '') }}"
                                        class="form-control"
                                        placeholder=""
                                        autocomplete="off"
                                    >
